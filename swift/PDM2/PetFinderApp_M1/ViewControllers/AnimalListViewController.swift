...
extension AnimalListViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        followAction.backgroundColor = animal.isFollowing ? UIColor.petFinderSecondary : UIColor.petFinderSuccess
...
class AnimalTableViewCell: UITableViewCell {
    ...
    func configure(with animal: AnimalEntity) {
        ...
        let heartColor: UIColor = animal.isFollowing ? .petFinderDanger : .systemGray
