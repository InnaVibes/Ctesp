...
# Instalar e carregar pacotes necessarios (se necessario)
...
# Importar dados do ficheiro Excel
# Ajustar o caminho conforme necessario
...
cat("\n--- MEDIDAS DE FORMA ---\n")
# install.packages("e1071") se necessario
library(e1071)
assimetria_aq <- skewness(dados$VRefAq)
curtose_aq <- kurtosis(dados$VRefAq) + 3  # Ajustar para escala com referencia em 3
...
# Grafico de barras (20 valores mais frequentes)
...
# 6.1. VRefAq por regiao
cat("\n--- COMPARACAO VRefAq POR REGIAO ---\n")
...
# 6.2. VRefAr por regiao
cat("\n--- COMPARACAO VRefAr POR REGIAO ---\n")
...
cat(sprintf("\nCoeficiente de Correlacao de Pearson: %.4f\n", correlacao))
...
# Adicionar correlacao no grafico
legend("topleft", 
...
cat("\n" , rep("=", 70), "\n", sep="")
cat("RESUMO ESTATISTICO COMPLETO\n")
cat(rep("=", 70), "\n", sep="")
...
cat("Todos os graficos foram guardados em formato PNG.\n")
cat(rep("=", 70), "\n", sep="")
